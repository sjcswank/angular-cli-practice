...
var AboutService = /** @class */ (function () {
    ...
    AboutService.prototype.getUserData = function () {
        return this.http.get("https://api.github.com/users/" + this.username + '?client_id=' + this.clientid + '&client_secret' + this.clientsecret).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
    };
...
var PortfolioService = /** @class */ (function () {
    ...
    PortfolioService.prototype.getReposData = function () {
        return this.http.get("https://api.github.com/users/" + this.username + '/repos?client_id=' + this.clientid + '&client_secret' + this.clientsecret).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
    };
...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(aboutService) {
        ...
        this.aboutService.getUserData().subscribe(function (user) {
            _this.user = user;
            console.log(user);
        });
    }
...
var PortfolioComponent = /** @class */ (function () {
    function PortfolioComponent(portfolioService) {
        ...
        this.portfolioService.getReposData().subscribe(function (repos) {
            _this.repos = repos;
            console.log(repos);
        });
    }
